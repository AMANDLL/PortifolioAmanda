...
namespace Calculadora_Basica
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Digite o primeiro valor, em seguida aperte a tecla entrer: ");
            ...
            Console.WriteLine("Digite a operação matemática desejada: ( /= divisão , * = multiplicação, + = soma, - = subtração e % = MOD resto ), em seguida aperte a tecla entrer: ");
            operador = Console.ReadLine();           

            Console.WriteLine("Digite o segundo valor, em seguida aperte a tecla entrer: ");
            valorDigitado = Console.ReadLine();
            numero_inteiro = double.TryParse(valorDigitado, out numero);
            if (numero_inteiro)
            {
